...
FROM reservation
WHERE from_date BETWEEN '2023-01-01' AND '2023-01-31';
...
-- Note to the creators of these query questions and instructions...
-- If you ask to 'select all of the columns', that is not the same as 'select each of the columns'.
-- The literal interpretation of the instructions are 'use *' but your note says 'but dont use *'...
-- Please write better questions/instruction.